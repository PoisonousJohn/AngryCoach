...
Styles.TextFieldStyle {
    ...
    font {
        family: control.echoMode == TextInput.Password ? "Default" : "Roboto"
    ...
    property int placeholderHorizontalAlignment: control.effectiveHorizontalAlignment
